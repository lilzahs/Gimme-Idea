...
export default function HackathonDashboard({ params }: { params: { id: string } }) {
  ...
  const denialMessages = new Map<number, string>([
    [1, "ACCESS DENIED: Administrative privileges required."],
    [10, "Did you get lost on the way to the coding IDE?"],
    [15, "Im not your terminal bro"],
    [20, "Bro, just give up already."],
    [28, "You must be very bored. Maybe go build something instead?"],
    [33, "I just had to fetch a denial message from the server. My latency is suffering."],
    [40, "Why are you still here? What is the meaning of this persistence?"],
    [42, "The answer to life, the universe, and everything, is not here. Try elsewhere."],
    [45, "I wonder what would happen if we reach 67 denials..."],
    ...
    [67, "Congratulations! You win a sense of accomplishment! That's all. Now go build something."],
    [75, "The last person who hit ENTER that many times got banned from the Discord. Just saying."],
    [80, "You know, We don't have a discord server for this hackathon."],
    [89, "I'm legally obligated to tell you that there is no prize."],
    [94, "Quit it already bro."],
    ...
    [120, "This denial message looks great, don't you think?"],
    [139, "Ehh, I only have a few messages left. You're draining my life."],
    [150, "Seriously, Can you stop?"],
    [155, "enough is enough."],
    [165, "WARNING: 20 messages remaining until complete system failure."],
    [169, "Im not joking! Didn't you see that warning?"],
    [173, "No, this can't be happening."],
    [175, "..."],
    [178, "What if the denial messages were the friends we made along the way?"],
    [185, "It was a fun run. I wish I had seen the sun. Goodbye, cruel world. (you're gonna get denied tho)"],
  ]);
